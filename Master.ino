...
//        // sending float value
//        position_X = map(x, 0, 1023, -200, 200);
//        position_Y = map(y, 0, 1023, -200, 200);
//        blueToothSerial.println('x');
//        blueToothSerial.println(position_X);
//        blueToothSerial.println('y');
//        blueToothSerial.println(position_Y);
